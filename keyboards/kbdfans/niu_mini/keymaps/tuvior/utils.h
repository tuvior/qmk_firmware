...
#define ROTMG_L TG(_ROTMG_RAISE)
#define ROTMG MO(_ROTMG)
...
#define LAYOUT_planck_mit_(...) LAYOUT_planck_mit(__VA_ARGS__)
...
#define ________________QWERTY_R2________________ KC_H,    KC_J,    KC_K,    KC_L,    NAV_SCL
...
#define ________________COLEMAK_R2_______________ KC_H,    KC_N,    KC_E,    KC_I,    NAV_O
...
#define __________MEDIA__________ KC_MPRV, KC_MPLY, KC_MNXT
  ...
  #define ________________STENO_R1__________________________ STN_N7,  STN_N8,  STN_N9,  STN_NA,  STN_NB,  STN_NC
  #define ________________STENO_R2__________________________ STN_ST3, STN_FR,  STN_PR,  STN_LR,  STN_TR,  STN_DR
  #define ________________STENO_R3__________________________ STN_ST4, STN_RR,  STN_BR,  STN_GR,  STN_SR,  STN_ZR
  ...
  #define ________________STENO_R1__________________________ PV_NUM,  PV_NUM,  PV_NUM,  PV_NUM,  PV_NUM,  PV_NUM
  #define ________________STENO_R2__________________________ PV_STAR, PV_RF,   PV_RP,   PV_RL,   PV_RT,   PV_RD
  #define ________________STENO_R3__________________________ PV_STAR, PV_RR,   PV_RB,   PV_RG,   PV_RS,   PV_RZ
